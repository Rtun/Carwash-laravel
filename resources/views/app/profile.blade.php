              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Servicios</b> <a class="float-right">{{count($servicio)}}</a>
                  </li>
                    ...
                    <div class="timeline timeline-inverse">
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          <span class="time"><i class="far fa-clock"></i> {{$servi->precio}}</span>

                          <h3 class="timeline-header"><a href="#">{{$servi->placa}}</a> {{$servi->modelo}}</h3>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputName" placeholder="Nombre" value="{{$socio->nombre}}">
                        </div>
                      </div>
                      <div class="form-group row">
